...
public class RecursiveFileObserver extends FileObserver {
    ...
    public void startWatching() {
        ...
        while (!stack.empty()) {
            ...
            if (files != null) {
                for (File file : files) {
                    LogCache.d("ObserverService", "Listed file at " + parent + ": " + file);
    ...
    private boolean isWatching(String path) {
        synchronized (mObservers) {
            FileObserver observer = mObservers.get(path);
    ...
    private class SingleFileObserver extends FileObserver {
        ...
        public void onEvent(int event, String path) {
            ...
            // Make sure media scanner doesn't interfere
            ...
            if (watch(file) && !isWatching(file.getAbsolutePath())) {
                RecursiveFileObserver.this.startWatching(file.getAbsolutePath());
            }
